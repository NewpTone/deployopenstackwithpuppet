...
我们规划每天晚上抽出3到4小时的不固定时间，计划在2个星期内（Crazy Plan）完成第一版的初稿工作，然后开始进入稳定的迭代周期。而这本书仅是一个起步，我构思了接下来的技术分享输出路线，比如说Ansible，CI, Rolling Upgrade等等，我们不想雷声大雨点小，因此这些事情在真正落到地面的时候，你会听到那些令人振奋的声音。
