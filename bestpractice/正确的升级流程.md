...
Puppet4的第一个正式版本于2015年4月15日发布，到它与3.x版本在许多方面都有很多很大的变化。

最大的变化在于Puppet4使用函数式编程语言Clojure对Puppet Master进行了重写，并新建了一个项目:puppetserver。如此脱胎换骨的动作，最主要的目的是为了提升性能，官方宣传新版本的Puppetserver将有2到3倍的性能提升。这是一个非常吸引人的提升！要知道Puppet2到Puppet3约50%的catalog编译的性能提升，就让我们感动不已了！

Puppet4一开始就拥有面向服务的架构：
